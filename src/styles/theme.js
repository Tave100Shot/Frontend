export const lightTheme = {
  colors : {
    ...
    colorAccentDark : '#00ADFA',
    colorAccentHover : 'rgba(145, 209, 250, 0.5)',
    colorOpposite: '#ffffff',
    colorWhiteShadow : 'rgba(255,255,255,0.3)',
    ...
    //커뮤니티 색
    levelbox: '#91D1FA',
    levelboxBorder: '#91D1FA',
    enterButton: '#ffffff',
    selectedFileText: '#333333',
    thumbsDown: '#FA9DAD',
    modalLayout: '#91d1fa',
...
export const darkTheme = {
  colors : {
    ...
    //커뮤니티 색
    levelbox: '#000000',
    levelboxBorder: '#ffffff',
    enterButton: '#B6FA91',
    selectedFileText: '#B6FA91',
    thumbsDown: '#FA91FA',
    modalLayout: '#FA91FA',
